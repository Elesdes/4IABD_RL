...
def monte_carlo_es_on_line_world(
        env: Any = LineWorldEnv(7), num_episodes: int = 10000, gamma: float = 0.1
) -> PolicyAndActionValueFunction:
    """
    Creates a TicTacToe Solo environment (Single player versus Uniform Random Opponent)
    Launches a Monte Carlo ES (Exploring Starts) in order to find the optimal Policy and its action-value function
    ...
    return PolicyAndActionValueFunction(dict(sorted(pi.items())), dict(sorted(q.items())))
...
def off_policy_monte_carlo_control_on_line_world(
        env: Any = LineWorldEnv(7), num_episodes: int = 10000, gamma: float = 0.1, epsilon: float = 0.1
) -> PolicyAndActionValueFunction:
    """
    Creates a TicTacToe Solo environment (Single player versus Uniform Random Opponent)
    Launches an Off Policy Monte Carlo Control algorithm in order to find the optimal greedy Policy and its action-value function
...
def monte_carlo_es_on_grid_world(
        env: Any = GridWorldEnv(5, 5), num_episodes: int = 10000, gamma: float = 0.1
) -> PolicyAndActionValueFunction:
    """
    Creates a TicTacToe Solo environment (Single player versus Uniform Random Opponent)
    Launches a Monte Carlo ES (Exploring Starts) in order to find the optimal Policy and its action-value function
...
def on_policy_first_visit_monte_carlo_control_on_grid_world(
        env: Any = GridWorldEnv(5, 5), num_episodes: int = 10000, gamma: float = 0.01
) -> PolicyAndActionValueFunction:
    """
    Creates a TicTacToe Solo environment (Single player versus Uniform Random Opponent)
    Launches an On Policy First Visit Monte Carlo Control algorithm in order to find the optimal epsilon-greedy Policy
...
def off_policy_monte_carlo_control_on_grid_world(
        env: Any = GridWorldEnv(5, 5), num_episodes: int = 10000, gamma: float = 0.1, epsilon: float = 0.1
) -> PolicyAndActionValueFunction:
    """
    Creates a TicTacToe Solo environment (Single player versus Uniform Random Opponent)
    Launches an Off Policy Monte Carlo Control algorithm in order to find the optimal greedy Policy and its action-value function
...
def demo():
    ...
    print("Monte Carlo ES on Line World")
    print(monte_carlo_es_on_line_world())
    print("On Policy First Visit Monte Carlo Control on Line World")
    print(on_policy_first_visit_monte_carlo_control_on_line_world())
    print("Off Policy Monte Carlo Control on Line World")
    print(off_policy_monte_carlo_control_on_line_world())

    print("Monte Carlo ES on Grid World")
    print(monte_carlo_es_on_grid_world())
    print("On Policy First Visit Monte Carlo Control on Grid World")
    print(on_policy_first_visit_monte_carlo_control_on_grid_world())
    print("Off Policy Monte Carlo Control on Grid World")
