...
import sys
import numpy as np
from algorithms.temporal_difference_learning import (
    sarsa_on_line_world,
            ...
            if event.type == pygame.QUIT:
                ...
                if (
                    ...
                    if (
                        ...
                        policy = sarsa_on_line_world(env).pi
                        play(env, policy)
                    elif (
                        WINDOW_HEIGHT / 2 - BUTTON_HEIGHT - BUTTON_SPACING * 0.5
                        < mouse_pos[1]
                        ...
                        policy = q_learning_on_line_world(env).pi
                        play(env, policy)
                    elif (
                        WINDOW_HEIGHT / 2 + BUTTON_SPACING * 0.5
                        < mouse_pos[1]
                        ...
                        policy = expected_sarsa_on_line_world(env).pi
                        play(env, policy)
                    elif (
                        WINDOW_HEIGHT / 2 + BUTTON_HEIGHT + BUTTON_SPACING * 1.5
                        < mouse_pos[1]
