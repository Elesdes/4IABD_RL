...
from algorithms.temporal_difference_learning import (sarsa_on_grid_world,
...
def main_menu():
    ...
    while running:
        ...
        draw_button(window, "Play with sarsa", WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
                    WINDOW_HEIGHT / 2 - BUTTON_HEIGHT * 2 - BUTTON_SPACING * 1.5, BUTTON_WIDTH, BUTTON_HEIGHT,
                    BUTTON_COLOR)
        draw_button(window, "Play with q learning", WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
                    WINDOW_HEIGHT / 2 - BUTTON_HEIGHT - BUTTON_SPACING * 0.5, BUTTON_WIDTH, BUTTON_HEIGHT, BUTTON_COLOR)
        draw_button(window, "Play with expected sarsa", WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
