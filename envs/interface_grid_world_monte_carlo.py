...
from algorithms.monte_carlo_methods import (monte_carlo_es_on_grid_world,
...
def main_menu():
    ...
    while running:
        ...
        draw_button(window, "Play with monte carlo es", WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
                    WINDOW_HEIGHT / 2 - BUTTON_HEIGHT * 2 - BUTTON_SPACING * 1.5, BUTTON_WIDTH, BUTTON_HEIGHT,
                    BUTTON_COLOR)
        draw_button(window, "Play with on policy monte carlo", WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
                    WINDOW_HEIGHT / 2 - BUTTON_HEIGHT - BUTTON_SPACING * 0.5, BUTTON_WIDTH, BUTTON_HEIGHT, BUTTON_COLOR)
        draw_button(window, "Play with off policy monte carlo", WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
